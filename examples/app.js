...
if(logResult.verbose.found) console.log("Being verbose!");

if(logResult.logging.found) console.log("Logging to file!");

if(logResult.logfile.found) console.log("Logfile set to "+logResult.logfile.value);
